...
EMAIL_HOST_USER = 'info@xn--denkmalgeschtztelofts-kic.de'
EMAIL_HOST_PASSWORD = 'denkmal123lofts'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
if "jazzmin" in INSTALLED_APPS:
    ...
    JAZZMIN_SETTINGS = {
        # title of the window
        "site_title": "Denkmalgeschützte Lofts",
        # Title on the brand, and the login screen (19 chars max)
        "site_header": "Denkmal Lofts",
        # square logo to use for your site, must be present in static files, used for favicon and brand on top left
        "site_logo": "denkmalgeschutztelofts/images/industry-logo.png",
        # Welcome text on the login screen
        # "welcome_sign": "Welcome to the library",
        # Copyright on the footer
        "copyright": "Denkmalgeschützte Lofts",
